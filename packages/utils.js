...
export const mark = {
  relationMark: 'id', // 这个应该是graph,node,link的唯一标识
  startMark: 'startId', // 这个应该是link独有，表达link的起点node的唯一标识
  endMark: 'endId' // 这个应该是link独有，表达link的终点node的唯一标识
}

// 产生uuid，不过似乎并没有放重复机制，只是单纯靠取值范围广
...
// 向量夹角（输入为二维坐标，输出360为一周的角度值，[1,0]为0度角）
